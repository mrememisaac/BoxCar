...
namespace BoxCar.Catalogue.Persistence.Repositories
{
    ...
    {
        protected readonly DbContextOptions<BoxCarDbContext> _dbContextOptions;

        public BaseRepository(DbContextOptions<BoxCarDbContext> dbContextOptions)
        {
        ...
        {
            await using var _dbContext = new BoxCarDbContext(_dbContextOptions);
